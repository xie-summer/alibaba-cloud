...
public class ServiceResourceAuthAutoConfigure {
    ...
    public FilterRegistrationBean serviceResourceAuthFilter(RestTemplate restTemplate,ServiceResourceAuthProperties serviceResourceAuthProperties, ApplicationContext applicationContext) {
